...
function editPet(petId, petName, species, breed, gender, petDOB, petOwnerId) {
...
function editAppointment(appointmentId, service_type, preferred_date, preferred_time, special_instructions, pet_profile_id, user_id) {
...
// FUNCTION: OPEN CLIENT DELETE POPUP
function deleteClient(clientId) {
    document.getElementById("delete-id").value = clientId;
    document.getElementById('deleteInput').placeholder = `DELETE ${clientId}`;
