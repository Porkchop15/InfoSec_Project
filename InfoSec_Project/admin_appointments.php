...
<section class="main-panel">
        ...
        <div class="trail">
            ...
            <a href="admin_appointments.php" class="current">APPOINTMENT MANAGEMENT</a>
        </div>
        <!-- END OF TRAIL -->
                ...
                <?php
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                            ...
                            <td>{$row['user_id']}</td>
                            <td>
                                <button class='edit' onclick='editAppointment({$row['appointment_id']}, \"{$row['service_type']}\", \"{$row['preferred_date']}\", \"{$row['preferred_time']}\", \"{$row['special_instructions']}\", \"{$row['pet_profile_id']}\", \"{$row['user_id']}\")'>
                ...
                <div class="popup-form">
                    <form action="" method="POST">
                        ...
                        <div class="box">
                            ...
                            <input list="userIds" name="userId" type="number" placeholder="Enter or Select User ID" required>
                            <datalist id="userIds">
                                <option value="1">
                                <option value="2">
                                <option value="3">
            ...
            <div class="popup-content">
                ...
                <div class="popup-form">
                    <form action="admin_appointments.php" method="POST">
                        ...
                        <div class="box">
                            <label for="userId">USER ID</label>
                            <input id="edit-userId" list="userIds" name="userId" type="number" placeholder="Enter or Select User ID" required>
                            <datalist id="userIds">
                                <option value="1">
                                <option value="2">
                                <option value="3">
    ...
    <div id="deletePopup" class="popup">
        <div class="popup-container">
            <div class="popup-content">
                ...
                <div class="popup-line"></div>
                <div class="popup-form">
                    <form id="deleteForm" action="admin_appointments.php" method="POST" onsubmit="return validateDeleteInput()">
